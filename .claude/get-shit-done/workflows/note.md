...
- **Global scope**: `C:/Users/avtka/Desktop/side project/Autonomous AI Trading System/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/avtka/Desktop/side project/Autonomous AI Trading System/.claude/notes/`)
...
2. Glob `C:/Users/avtka/Desktop/side project/Autonomous AI Trading System/.claude/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/avtka/Desktop/side project/Autonomous AI Trading System/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/avtka/Desktop/side project/Autonomous AI Trading System/.claude/notes/` — works in any directory
