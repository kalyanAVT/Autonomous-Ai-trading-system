...
```bash
debugger_model=$(node "C:/Users/avtka/Desktop/side project/Autonomous AI Trading System/.claude/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-debugger --raw)
```
